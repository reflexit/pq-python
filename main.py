...
class ProgressQuestGUI:
    ...
    def setup_gui(self):
        ...
        self.char_frame.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")

        self.lbl_level = tk.Label(self.char_frame, text="", anchor="w", font=("Arial", 10, "bold"))
        self.lbl_level.grid(row=0, column=0, padx=5, pady=2, sticky="ew")

        self.lbl_hp_mp = tk.Label(self.char_frame, text="", anchor="w", justify=tk.LEFT, font=("Arial", 10))
        self.lbl_hp_mp.grid(row=1, column=0, padx=5, pady=2, sticky="ew")

        self.lbl_stats = tk.Label(self.char_frame, text="", anchor="w", justify=tk.LEFT, font=("Arial", 10))
        self.lbl_stats.grid(row=2, column=0, padx=5, pady=2, sticky="ew")

        # ---------------- 2. Equipment ----------------
        self.equip_frame = tk.LabelFrame(self.root, text="Equipment")
        self.equip_frame.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")
        ...
        self.spell_frame.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")
        ...
        self.inv_frame.grid(row=1, column=1, padx=10, pady=5, sticky="nsew")
        ...
        self.quest_frame.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")
